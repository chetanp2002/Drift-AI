...
os.environ["REQUEST_CA_BUNDLE"]= certifi.where()  # for windows path issue

API_KEY= os.getenv("AVIATIONSTACK_API_KEY")

# Default origin when user says only destination, eg. "dubai trip"
DEFAULT_ORIGIN_IATA= os.getenv("DEFAULT_ORIGIN_IATA", "MAH")
